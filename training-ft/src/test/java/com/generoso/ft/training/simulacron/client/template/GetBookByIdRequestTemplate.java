...
public class GetBookByIdRequestTemplate extends RequestTemplate {

    @Autowired
    public GetBookByIdRequestTemplate(@Value("${service.host}") String host,
    ...
    public Endpoint getEndpoint() {
        return Endpoint.GET_BOOK_BY_ID;
    }
}
